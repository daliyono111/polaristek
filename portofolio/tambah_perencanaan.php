        ...
        if (in_array($ekstensi, $ekstensi_diizinkan) === true) {
            if ($ukuran_file < 2048000) { // Maksimal 2MB
                ...
                if (move_uploaded_file($tmp_file, $tujuan)) {
                    ...
                    // Simpan ke database (foto2 & foto3 menggunakan nilai NULL jika kosong)
                    $f2_val = $nama_file_baru2 ? "'$nama_file_baru2'" : "NULL";
                    $f3_val = $nama_file_baru3 ? "'$nama_file_baru3'" : "NULL";

                    $query = "INSERT INTO portofolio_perencanaan (kategori, nama_proyek, deskripsi, foto, foto2, foto3) 
                              VALUES ('$kategori', '$nama_proyek', '$deskripsi', '$nama_file_baru', $f2_val, $f3_val)";
                    $result = mysqli_query($conn, $query);

                    if ($result) {
                        $pesan = "<div class='alert alert-success'>Data portofolio perencanaan beserta slider foto berhasil disimpan!</div>";
                    } else {
...
<head>
    ...
    <title>Tambah Portofolio Bidang Perencanaan - PT. POLARISTEK ADHI PERSADA</title>
    <!-- Bootstrap 5 CSS -->
        ...
        <div class="col-md-7">
            <div class="card shadow border-0">
                <div class="card-header bg-dark text-white text-center py-3">
                    <h4 class="mb-0 fw-bold">Form Input Portofolio Bidang Perencanaan</h4>
                </div>
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="kategori" name="kategori" required>
                                <option value="" selected disabled>-- Pilih Kategori Perencanaan --</option>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nama_proyek" name="nama_proyek" placeholder="Contoh: Perencanaan Pembangunan Gedung Kantor" required>
                        </div>
                        <div class="mb-3">
                            <label for="deskripsi" class="form-label fw-bold">Deskripsi Proyek</label>
                            <textarea class="form-control" id="deskripsi" name="deskripsi" rows="4" placeholder="Tuliskan detail atau deskripsi proyek perencanaan..." required></textarea>
                        </div>
