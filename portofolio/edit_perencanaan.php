...
if (!isset($_GET['id']) || empty($_GET['id'])) {
    echo "<script>alert('ID Proyek tidak ditemukan!'); window.location='bidang_perencanaan.php';</script>";
    exit();
}
...
$query_data = mysqli_query($conn, "SELECT * FROM portofolio_perencanaan WHERE id = '$id'");
$data = mysqli_fetch_assoc($query_data);

if (!$data) {
    echo "<script>alert('Data tidak ditemukan di database!'); window.location='bidang_perencanaan.php';</script>";
    exit();
}
...
if (isset($_POST['update'])) {
    ...
    // Eksekusi query jika belum ada pesan error
    if (empty($pesan)) {
        $query = "UPDATE portofolio_perencanaan SET kategori = '$kategori', nama_proyek = '$nama_proyek', deskripsi = '$deskripsi' $update_bagian_foto WHERE id = '$id'";
        $result = mysqli_query($conn, $query);
        
        if ($result) {
            echo "<script>alert('Data portofolio beserta slider foto berhasil diperbarui!'); window.location='bidang_perencanaan.php';</script>";
            exit();
        } else {
...
<head>
    ...
    <title>Edit Portofolio Bidang Perencanaan - PT. POLARISTEK ADHI PERSADA</title>
    <!-- Bootstrap 5 CSS -->
        ...
        <div class="col-md-7">
            <div class="card shadow border-0">
                <div class="card-header bg-dark text-white text-center py-3">
                    <h4 class="mb-0 fw-bold">Form Edit Portofolio Bidang Perencanaan</h4>
                </div>
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="kategori" name="kategori" required>
                                <option value="" disabled>-- Pilih Kategori Perencanaan --</option>
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <a href="bidang_perencanaan.php" class="btn btn-secondary">Kembali ke Halaman Perencanaan</a>
                        </div>
                    </form>
